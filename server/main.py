...
const DK_QUOTES = [
  ...
  ["세상에서 보고 싶은 <em>변화</em>가 되어라.", "간디"],
  ["내일 죽을 것처럼 살고, <em>영원히 살 것</em>처럼 배워라.", "간디"],
  ...
  ["문화는 전략을 <em>아침으로</em> 먹는다.", "피터 드러커"],
  ["단순함이 <em>궁극의 정교함</em>이다.", "레오나르도 다 빈치"],
  ["세상에서 가장 어려운 일은 <em>시작하는</em> 일이다.", "톨스토이"],
  ["모두가 세상을 바꾸려 하지만 <em>자신</em>을 바꾸려 하진 않는다.", "톨스토이"],
  ["행복은 이미 가진 것에 <em>감사</em>할 때 온다.", "에픽테토스"],
  ...
  ["한겨울, 내 안에 <em>무적의 여름</em>이 있음을 알았다.", "알베르 카뮈"],
  ...
  ["삶은 뒤돌아볼 때 이해되지만, <em>앞을 향해</em> 살아야 한다.", "키르케고르"],
  ["산다는 것은 세상에서 가장 <em>드문 일</em>이다. 대부분은 존재할 뿐.", "오스카 와일드"],
  ...
  ["당신의 브랜드는 당신이 없을 때 사람들이 하는 <em>말</em>이다.", "제프 베조스"],
  ...
  ["평판을 쌓는 데 20년, 무너뜨리는 데 <em>5분</em>이면 된다.", "워런 버핏"],

  // ── 생각·태도 ────────────────────────────────────────────
  ["같은 강물에 <em>두 번</em> 발을 담글 수는 없다.", "헤라클레이토스"],
  ["인간은 <em>생각하는 갈대</em>다.", "파스칼"],
  ["나는 생각한다, 그러므로 <em>존재한다</em>.", "데카르트"],
  ["내 삶엔 끔찍한 불행이 가득했다. <em>대부분</em>은 일어나지 않았다.", "몽테뉴"],
  ["우물 안 개구리에게 <em>바다</em>를 말할 수 없다.", "장자"],
  ["큰 지혜는 넉넉하고, 작은 지혜는 <em>따진다</em>.", "장자"],
  ["백문이 <em>불여일견</em>이다.", "한서"],
  ["사람은 자기가 보고 싶은 <em>현실</em>만 본다.", "율리우스 카이사르"],
  ["분노로 시작한 일은 <em>수치</em>로 끝난다.", "벤저민 프랭클린"],
  ["말할 수 없는 것에 대해서는 <em>침묵</em>해야 한다.", "비트겐슈타인"],
  ...
  ["희망은 좋은 아침 식사지만 <em>형편없는 저녁</em>이다.", "프랜시스 베이컨"],
